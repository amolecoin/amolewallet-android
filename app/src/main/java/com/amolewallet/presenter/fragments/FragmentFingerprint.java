...
import com.amolecoin.tools.security.FingerprintUiHelper;
...
//                dismiss();
    ...
    public void onAuthenticated() {
        ...
        BRAnimator.startAmoleIfNotStarted(app);
    ...
    private void animateSignalSlide(final boolean reverse) {
        ...
        if (!reverse) {
            fingerPrintLayout.setTranslationY(layoutTY + AmoleActivity.screenParametersPoint.y);
