...
import static com.amolecoin.R.color.white;
import static com.amolecoin.tools.util.BRConstants.PLATFORM_ON;
import static com.amolecoin.tools.util.BRConstants.SCANNER_REQUEST;
...
public class LoginActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keyboard.setAmoleground(getDrawable(R.drawable.amole_gradient));
        ...
        unlockedImage.animate().alpha(1f).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(LoginActivity.this, AmoleActivity.class);
                        startActivity(intent);
