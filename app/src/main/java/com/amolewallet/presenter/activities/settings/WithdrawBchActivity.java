package com.amolecoin.presenter.activities.settings;
...
import com.amolecoin.presenter.interfaces.BRAuthCompletion;
import com.amolecoin.tools.animation.BRAnimator;
import com.amolecoin.tools.animation.BRDialog;
import com.amolecoin.tools.manager.BRClipboardManager;
...
import static com.amolecoin.tools.util.BRConstants.SCANNER_BCH_REQUEST;
...
public class WithdrawBchActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String iso = BRSharedPrefs.getPreferredBTC(this) ? "AMC" : BRSharedPrefs.getIso(this);
        BigDecimal amount = iso.equalsIgnoreCase("AMC") ?
        ...
        txHash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BRToast.showCustomToast(WithdrawBchActivity.this, getString(R.string.BCH_hashCopiedMessage), AmoleActivity.screenParametersPoint.y / 2, Toast.LENGTH_LONG, 0);
            }
        });
...
//                    }
    ...
    public static void setBCHTxId(String txId) {
        ...
        if (app != null) {
            ...
            Context activity = AmoleApp.getAmoleContext();
