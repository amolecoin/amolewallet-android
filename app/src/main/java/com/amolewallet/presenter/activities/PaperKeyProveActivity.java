...
import com.amolecoin.tools.security.SmartValidator;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isWordCorrect(true) && isWordCorrect(false)) {
                    ...
                    BRAnimator.showAmoleSignal(PaperKeyProveActivity.this, getString(R.string.Alerts_paperKeySet), getString(R.string.Alerts_paperKeySetSubheader), R.drawable.ic_check_mark_white, new BROnSignalCompletion() {
                        @Override
                        public void onComplete() {
                            BRAnimator.startAmoleActivity(PaperKeyProveActivity.this, false);
