...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        BigDecimal amount = BRExchange.getAmountFromSatoshis(this, "AMC", satoshis);
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), BRCurrency.getFormattedCurrencyString(this, "AMC", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
//        BRAnimator.startAmoleActivity(this, false);
